...
//      rate=rate||3.5;  //Присвоєння значень за замовчуванням
//      years=years||5;
//
...
function op(x,y,func){
 return func(x,y,func);
}
console.log(op(2,3,sum));
