...
console.log(jake)
jake.name="Jake";
jake.company.title="Google"//десь свойство company объекта jane представляет объект с одним свойством. И при копировании объект jake получит не копию значения jane.company, а ссылку на этот объект.
console.log(jane)
console.log(jake)
